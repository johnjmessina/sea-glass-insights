  ...
  return (
    <div className="flex flex-col min-h-full" style={{ backgroundColor: SAND }}>
      ...
      <section style={{ backgroundColor: WHITE, padding: "24px 24px", textAlign: "center" }}>
        ...
        <Link href="/services/synthetic-survey-report" style={{ fontFamily: MT, fontWeight: 600, fontSize: "0.9rem", color: NAVY, textDecoration: "underline", textUnderlineOffset: "3px" }}>See Synthetic Customer Profiles instead →</Link>
      </section>
      <SiteFooter />
    </div>
  );
