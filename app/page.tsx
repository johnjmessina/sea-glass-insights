...
const SERVICES = [
  ...
  { name: "Synthetic Customer Profiles", href: "/services/synthetic-survey-report" },
  ...
  return (
    <div className={`${cormorant.variable} ${montserrat.variable}`} style={{ backgroundColor: SAND, color: NAVY }}>
      ...
      <section style={{ backgroundColor: SAND, textAlign: "center", padding: "48px 24px 18px" }}>
        ...
        >
          Sea Glass Insights delivers professional market research for small businesses on the Jersey Shore. AI generates the foundation — a market research professional refines it.
        </p>
